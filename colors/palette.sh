...
export COLOR_RED="#ea6962"
export COLOR_GREEN="#a9b665"
export COLOR_YELLOW="#d8a657"
export COLOR_BLUE="#83a598"
export COLOR_MAGENTA="#d3869b"
export COLOR_CYAN="#89b482"
export COLOR_GREY="#928374"
export COLOR_WHITE="#d4d4d4"
