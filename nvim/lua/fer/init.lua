...
vim.opt.diffopt = {"internal", "filler", "closeoff", "context:12", "algorithm:histogram", "linematch:200",
                   "indent-heuristic"}
...
vim.api.nvim_set_keymap("n", "<C-S-e>", ":lua ToggleTreeFocus()<CR>", {
    noremap = true,
    silent = true
})
vim.api.nvim_set_keymap("n", "<C-e>", ":lua ToggleTreeFocus()<CR>", {
    noremap = true,
    silent = true
})
...
vim.api.nvim_set_keymap("n", "dc", "dd", {
    noremap = true,
    silent = true
})
vim.api.nvim_set_keymap("v", "dc", "_d", {
    noremap = true,
    silent = true
})
...
vim.api.nvim_set_keymap("i", "<Esc>", "<Esc>", {
    noremap = true,
    silent = true
})
vim.api.nvim_set_keymap("n", "<Esc>", "<Esc>", {
    noremap = true,
    silent = true
})

-- Change search function to prevent getting moved back after pressing ESC
vim.api.nvim_set_keymap("c", "<ESC>", "<CR>", {
    noremap = true,
    silent = true
})
...
vim.api.nvim_set_keymap("n", "<C-h>", ":lua GoToPrevBuffer()<CR>", {
    noremap = true,
    silent = true
})
vim.api.nvim_set_keymap("n", "<C-l>", ":lua GoToPrevBuffer()<CR>", {
    noremap = true,
    silent = true
})
vim.api.nvim_set_keymap("n", "<C-[>", ":lua GoToPrevBuffer()<CR>", {
    noremap = true,
    silent = true
})
vim.api.nvim_set_keymap("n", "<C-]>", ":lua GoToNextBuffer()<CR>", {
    noremap = true,
    silent = true
})
...
vim.api.nvim_set_keymap("v", "<C-v>", "<C-w><C-v>", {
    noremap = true,
    silent = true
})
vim.api.nvim_set_keymap("n", "<D-v>", "<C-w><C-v>", {
    noremap = true,
    silent = true
})
...
-- Custom utils
vim.api.nvim_set_keymap("v", "<leader>ck", [[:s/"\(\w\+\)":/\1:/g<CR>]], {
    noremap = true,
    silent = true
}) -- Custom regex to clean quotes marks quotes from objects
...
vim.api.nvim_set_keymap("n", "J", "<Nop>", {
    noremap = true,
    silent = true
})
vim.api.nvim_set_keymap("v", "K", "<Nop>", {
    noremap = true,
    silent = true
})
vim.api.nvim_set_keymap("v", "J", "<Nop>", {
    noremap = true,
    silent = true
})
